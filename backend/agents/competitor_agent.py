"""Competitor agent — single responsibility: gather evidence about existing
rivals and substitutes for this venture.
...
from prompts.competitor import SYSTEM_PROMPT, build_prompt
